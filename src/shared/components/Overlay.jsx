...
// Smooth-scroll to a fraction (0–1) of the total page scroll. Works from
// anywhere in the journey — including once the inner world has taken over —
// because every phase is driven off this single window scroll position.
...
const NavbarItem = () => {
  ...
  return (
    <ul className="">
      {navbarItems.map(({ name, scroll }, index) => (
